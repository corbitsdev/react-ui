...
export function SidebarPanel({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-full w-72 shrink-0 flex-col border-r border-border bg-card text-card-foreground",
        className,
      )}
      {...props}
    />
...
export function SidebarPanelHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "flex min-h-14 shrink-0 items-center justify-between gap-2 border-b border-border px-3",
        className,
      )}
      {...props}
    >
 ...
 */
export function SidebarPanelPins({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
