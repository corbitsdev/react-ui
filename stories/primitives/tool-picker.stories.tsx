...
const ITEMS: ToolPickerItem[] = [
  ...
  },
  {
    ...
    name: "Add reaction",
    package: "slack",
    description: "Reacts to an existing message.",
  },
  {
    id: "linear-create",
    name: "Create issue",
  ...
  },
  {
    ...
    name: "Send email",
    package: "gmail",
    description: "Sends a message from the connected inbox.",
  },
];
...
export const Loading = () => (
  <ToolPicker items={[]} value={[]} onChange={() => {}} loading />
);

export const Empty = () => (
  <ToolPicker items={[]} value={[]} onChange={() => {}} />
);
